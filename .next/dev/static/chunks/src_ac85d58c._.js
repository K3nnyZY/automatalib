...
function Home() {
    ...
    const [machineType, setMachineType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("mDFA");
    ...
    const generateAutomaton = ()=>{
        try {
            setError(null);
            let automata;
            if (machineType === "mDFA") automata = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$mdfa$2e$class$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mDFA"](expression);
            else if (machineType === "uDFA") automata = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uDFA"](expression);
            else automata = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NFA"](expression);
...
_s(Home, "W9rvkB+11hyhzw+ocuAyMK2SQJA=");
_c = Home;
var _c;
