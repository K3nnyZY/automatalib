...
"[project]/src/features/automata/base-automaton.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/automata/regex.class.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/automata/nfa.class.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$regex$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/regex.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/base-automaton.ts [app-rsc] (ecmascript)");
;
;
class NFA extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Automaton"] {
    ...
    build(expression) {
        ...
        const generateGraph = (stNode, initialState)=>{
            switch(stNode.type){
                case "empty":
                    {
                        const acceptState = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["State"](++label);
                ...
                case "or":
                    {
                        ...
                        for (const part of stNode.parts){
                            const nextState = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["State"](++label);
                ...
                case "optional":
                    {
                        const tempInitialState = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["State"](++label);
        ...
        this.regexp = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$regex$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["RegExp"](expression, this.empty_symbol);
        const st = this.regexp.syntax_tree;
        const initialState = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["State"](label);
   ...
   */ enclosure(T, symbol = this.empty_symbol) {
    ...
    generateTransitionsTable() {
        ...
        this.transitions = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TransitionsTable"]();
        const visited = new Set();
        // Use depth-first search algorithm
...
"[project]/src/features/automata/automata.utils.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/automata/dfa.class.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/base-automaton.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/automata.utils.ts [app-rsc] (ecmascript)");
;
;
class StatesTable {
    table;
    ...
    get(states) {
        for (const row of this.table){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["equalStates"])(row.states, states)) return row;
        }
        return null;
    }
    add(label, states) {
...
class DFA extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Automaton"] {
    lookUp(label, states) {
    ...
    generateGraph() {
        ...
        for (const entry of this.states.table){
            const state = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["State"](entry.label);
            newStates.add(state);
...
"[project]/src/features/automata/udfa.class.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/base-automaton.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/nfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/dfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/automata.utils.ts [app-rsc] (ecmascript)");
;
;
;
;
class uDFA extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DFA"] {
    constructor(expression, config){
        super(expression, config);
    }
    build(expression) {
        const subsetConstruction = (nfa)=>{
            ...
            const states = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StatesTable"]();
            const transitions = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TransitionsTable"]();
            const labeler = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["LetterGenerator"]();
        ...
        this.NFA = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NFA"](expression, this.config);
...
"[project]/src/features/automata/mdfa.class.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/dfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/automata.utils.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/udfa.class.ts [app-rsc] (ecmascript)");
;
;
;
;
...
class mDFA extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DFA"] {
    constructor(expression, config){
        super(expression, config);
    }
    build(expression) {
        const udfa = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uDFA"](expression, this.config);
        this.NFA = udfa.NFA;
        this.uDFA = udfa;
    ...
    reduce(equivalentStates, transitions) {
        ...
        for(let i = 0; i < newStates.length; i++){
            for(let j = i + 1; j < newStates.length; j++){
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$automata$2e$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["equalStates"])(newStates[i].states, newStates[j].states)) {
        ...
        const mdfaStates = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StatesTable"]();
        mdfaStates.table = new Set(newStates);
        const mdfaTransitions = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TransitionsTable"]();
...
"[project]/src/features/automata/index.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/udfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/nfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$mdfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/mdfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$base$2d$automaton$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/base-automaton.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$dfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/dfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$regex$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/regex.class.ts [app-rsc] (ecmascript)");
;
...
"[project]/src/config/cytoscape.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$cytoscapejs$2f$dist$2f$react$2d$cytoscape$2e$modern$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-cytoscapejs/dist/react-cytoscape.modern.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cytoscape$2f$dist$2f$cytoscape$2e$esm$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/cytoscape/dist/cytoscape.esm.mjs [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cytoscape$2d$dagre$2f$cytoscape$2d$dagre$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/cytoscape-dagre/cytoscape-dagre.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/features/automata/index.ts [app-rsc] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$mdfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/mdfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/udfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/automata/nfa.class.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cytoscape$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/cytoscape.ts [app-rsc] (ecmascript)");
;
;
;
;
...
;
;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cytoscape$2f$dist$2f$cytoscape$2e$esm$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].use(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cytoscape$2d$dagre$2f$cytoscape$2d$dagre$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]);
function Home() {
    const [expression, setExpression] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    const [machineType, setMachineType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("NFA");
    const [automaton, setAutomaton] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(null);
    const [elements, setElements] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [testString, setTestString] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])("");
    const [testResult, setTestResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(null);
    const [selectedRouteIndex, setSelectedRouteIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])(null);
    const cyRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useRef"])(null);
    const timeoutsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useRef"])([]);
    const generateAutomaton = (overrideType)=>{
        try {
            ...
            if (targetType === "mDFA") instance = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$mdfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mDFA"](expression);
            else if (targetType === "uDFA") instance = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$udfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uDFA"](expression);
            else instance = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$automata$2f$nfa$2e$class$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NFA"](expression);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (cyRef.current && elements.length > 0) {
            cyRef.current.layout(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cytoscape$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cytoscape_layout"]).run();
            cyRef.current.fit();
    ...
    const symbols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!automaton) return [];
    ...
    const transitionsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        Array.from(automaton.transitions.table).forEach((row)=>{
            const rowData = {
                state: row.label
            };
            symbols.forEach((sym)=>{
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    transitionsData.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        ...
                                                        symbols.map((sym)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                                className: "font-semibold py-2",
                                                                children: sym
                                                            }, sym, false, {
                                                                fileName: "[project]/src/app/page.tsx",
                                                        ...
                                                        machineType === "NFA" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                            className: "font-semibold py-2",
                                                            children: "ε"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/page.tsx",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                children: transitionsData.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        children: [
                                                            ...
                                                            symbols.map((sym)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            machineType === "NFA" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "py-2.5 font-mono text-slate-600",
                                                                children: row["empty"]
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/page.tsx",
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    error ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        lineNumber: 284,
                                        columnNumber: 29
                                    }, this) : elements.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$cytoscapejs$2f$dist$2f$react$2d$cytoscape$2e$modern$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
                                        elements: elements,
                                        layout: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cytoscape$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cytoscape_layout"],
                                        stylesheet: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$cytoscape$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cytoscape_styles"],
                                        style: {
                                            width: "100%",
                                            height: "100%"
                                        },
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex-1 bg-white border border-slate-200 shadow-sm rounded-md p-3 overflow-y-auto custom-scrollbar flex flex-col",
                                        children: testResult === null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: testResult.routes.map((route, rIndex)=>{
                                                        ...
                                                        ${route.valid ? 'bg-emerald-50 border-emerald-300' : 'bg-slate-50 border-slate-200 text-slate-500'}`,
                                                            children: [
                                                                ...
                                                                route.transitions.map((t, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "inline-flex items-center",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: `inline-block px-1.5 py-0.5 rounded border transition-colors ${i === route.transitions.length - 1 && route.valid ? 'bg-emerald-500 border-emerald-600 text-white font-bold shadow-sm' : route.valid ? 'bg-emerald-100 border-emerald-300 text-emerald-800' : 'bg-white border-slate-200 text-slate-600'}`,
                                                                            ...
                                                                            t.symbol !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__287e3d38._.js.map